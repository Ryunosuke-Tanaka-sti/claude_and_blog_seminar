...
## 型定義・関数のパーツ化でハチャメチャなコードを防ぐ
### モノレポ × 自動生成パイプライン実践セミナー
...
**cc-sdd**（日本製）、**spec-workflow-mcp**、**BMAD-METHOD**
...
**実測データ**: RAGもどきでトークン削減50-60%、記事執筆時間50%削減
...
| セクション | 時間 | 内容 |
|---|---|---|
| **Part 1** | 10分 | AI開発の課題と環境整備の必要性 |
| **モノレポ** | 5分 | パイプライン構築の前提となる基盤 |
...
# Part 1: AI開発の課題と環境整備の必要性

## なぜAIはハチャメチャなコードを出すのか
